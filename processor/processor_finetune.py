...
def do_train(start_epoch, args, model, train_loader, evaluator, optimizer,
    ...
    meters = {
        ...
        "avm_plain_ret": AverageMeter(),
        "avm_masked_ret": AverageMeter(),
    ...
    for epoch in range(start_epoch, num_epoch + 1):
        ...
        for n_iter, batch in enumerate(train_loader):
            ...
            meters['avm_plain_ret'].update(
                ret.get('avm_plain_ret', 0), batch_size
            )
            meters['avm_masked_ret'].update(
                ret.get('avm_masked_ret', 0), batch_size
            )
